...
Core::Core()
{
	...
	std::unique_ptr<PathplannerVisualizer> visualizer{new PathplannerVisualizer{std::make_unique<AStarPathplanner>([] (...) { return 0; }, *grid), *grid, (*grid)[grid->toIndex({14, 15})], (*grid)[grid->toIndex({28, 1})]}};
